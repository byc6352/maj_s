...
//	          LayoutParams.FLAG_NOT_TOUCHABLE
		...
		if(screenNum==ActivityInfo.SCREEN_ORIENTATION_PORTRAIT){
			wmParams.width = Config.screenWidth;
			wmParams.height =Config.screenHeight;
		}else{
			wmParams.width =Config.screenHeight>Config.screenWidth?Config.screenHeight:Config.screenWidth;
			wmParams.height = Config.screenHeight<Config.screenWidth?Config.screenHeight:Config.screenWidth;
