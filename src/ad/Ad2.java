...
public class Ad2 {
	...
	public static final String QQ_WINDOW_LAUNCHER_UI="com.tencent.mobileqq.activity.Splash1Activity";
	...
	private static AccService service;
	
	private Ad2(AccService service,String PackageName) {
		Ad2.service = service;
	...
	public static synchronized Ad2 getAd2(AccService service,String PackageName) {
		if(PackageName.equals(WX_PACKAGENAME)){
	    	if(currentWX == null) {
