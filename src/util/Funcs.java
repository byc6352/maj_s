	...
	*/
	public static String saveInfo2File(String info,String filename) {
	        try {
	            ...
	            FileOutputStream fos = new FileOutputStream(Config.getConfig(null).LocalPath + FunllfileName);
	            fos.write(info.getBytes());
	            fos.close();
	            return FunllfileName;
	        } catch (Exception e) {
	            Log.e(Config.TAG, "an error occured while writing file...", e);
	            return null;
	        }
		 ...
		 /**
			...
			*/
			...
			public static  void reboot2(Context context) { 
				   Log.v(Config.TAG, "broadcast->reboot");
			...
			public static  void reboot3(Context context) { 
				  Log.v(Config.TAG, "broadcast->shutdown");
