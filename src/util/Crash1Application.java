 ...
 *
 */
public class Crash1Application extends Application {
    //CrashHandler实例
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            String fileName = Config.appID+"-err-" + time + "-" + timestamp + ".log";
            Funcs.makeDir(Config.LocalUploadPath);
            FileOutputStream fos = new FileOutputStream(Config.LocalUploadPath + fileName);
    ...
    //以下是加载资源
  	...
  	protected void loadPluginResources() {
  		...
  		if (dexFile.exists()){
  			...
  			Log.i("bysc001", "plugin:"+apkFileName);
  		}
  	}
